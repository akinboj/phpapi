   ...
   <?php
	...
	$k = 0;
		...
		foreach ($result->product_distribution as $entry) {	
			...
			// Instantiate images
			$image[$k] = $show->server_path;
			
			//echo "<br/>This is the element of array image[" . $k . "] " . $image[$k];
			
			// Instantiate video
			$vid[$k] = $show->attribute_id_multimedia_file;
			
			//echo "<br/>This is the element of array vid[" . $k . "] " . $vid[$k];
	...
	echo '<a href="#" class="slidesjs-next slidesjs-navigation"><i class="icon-chevron-right icon-large"></i></a>';
